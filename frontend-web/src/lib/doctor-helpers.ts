...
const STATUS_MAP: Record<string, StatusInfo> = {
  ...
  approved_pending_payment: { label: 'Aguardando pagamento',     variant: 'outline',      color: 'text-amber-600',   bgColor: 'bg-amber-50 border-amber-200',     icon: CheckCircle2,  priority: 3 },
  paid:                     { label: 'Pago',                     variant: 'outline',      color: 'text-blue-600',    bgColor: 'bg-blue-50 border-blue-200',       icon: CheckCircle2,  priority: 3 },
