...
public interface IDocumentSecurityService
{
    ...
    Task<(bool success, string? error)> RecordDispensationAsync(Guid documentId, string dispensedBy, string? pharmacistName, string? pharmacistCrf, string? ip, CancellationToken ct);
